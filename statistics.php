...
?>
  ...
  <div id="container1">
    <div class="title">
        ...
        <div class="panel-body">
          ...
          <div class="chart">
            <div class="types">
                <span>Maskedball</span>
                <span>Futurism</span>
                <span>Cabaret</span>
            </div>
            <div class="cabaret-stats">
            </div>
            <div class="maskedball-stats">
            </div>
            <div class="futurims-stats">
            </div>
 ...
 <div id="container2">
    <div class="title">
        ...
        <p>CABARET</p>
        <div class="container">
            <div class="skills cabaret">90%</div>
        </div>
        <p>FUTURISM</p>
        <div class="container">
            <div class="skills futurism">80%</div>
        </div>
        <p>MASKEDBALL</p>
            <div class="container">
             <div class="skills maskedball">65%</div>
             </div>

        <p>OTHER</p>
        <div class="container">
  <div class="skills other">60%</div>
</div>
</div>
</div>
<div id="container4">
    ...
    <img src="images/histogram2.png" alt=" ">
    </div>
<div id="container5">
    <div class="title">
    <h1>Statistics</h1>
    </div>
    <img src="images/histogram3.png" alt=" ">
    </div>
